...
This specification is maintained by **Factorial GmbH**, who also build two of its
...
- **Reports that a rule is wrong** are the most valuable contribution here and are
  always worth filing, whether or not you propose a fix.

## Implementations

Any implementation may aim at this specification. Doing so grants no rights in the
FlowDrop trademark and creates no relationship with Factorial GmbH. This
repository does not track, endorse, or rank implementations.
